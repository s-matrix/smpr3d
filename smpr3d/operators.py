# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/01g_util_shift.ipynb (unless otherwise specified).
...
class ImageShiftGradientBased(nn.Module):
    ...
    def __init__(self, shape, dtype=torch.float32, device=torch.device('cuda'), **kwargs):
        ...
        pixel_size = 1.0
        self.ky_lin, self.kx_lin = op.generate_grid_2d(shape, pixel_size, flag_fourier=True, dtype=dtype, device=device)
