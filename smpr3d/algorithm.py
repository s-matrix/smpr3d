# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/10a_algorithm_fasta.ipynb (unless otherwise specified).


from __future__ import annotations


__all__ = ['fasta2', 'is_correlation_method', 'is_valid_method', 'TorchTomographySolver', 'AETDataset',
           'PhaseContrastScattering', 'bin_obj', 'complex_abs', 'possible_methods', 'correlation_methods',
...
class SMPRSolution:
    ...
    def to_h5(self, file_path, key = 'solution'):
    ...
    @staticmethod
    def from_h5(file_path, key = 'solution'):
